...
// =========================== 
// $route['(:any)/auction-approved']                         = "(:any)/admin/content/auction_approved";
// $route['(:any)/auction-pending']                         = "(:any)/admin/content/auction_pending";
// $route['(:any)/auction-close']                         = "(:any)/admin/content/auction_close";
// =========================== 
