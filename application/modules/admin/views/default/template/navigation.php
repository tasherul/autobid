...
<div id="sidebar" class="navbar-collapse collapse">
    ...
    <ul class="nav nav-list">
        ...
        <?php if (is_admin()) { ?>
            <li class="<?php echo is_active_menu('admin/slider'); ?>">
                ...
                <ul class="submenu">
                    ...
                    <li class="<?php echo is_active_menu('admin/slider/all'); ?>"><a href="<?php echo site_url('admin/slider/all'); ?>"><?php echo lang_key('all'); ?></a></li>
                    <li class="<?php echo is_active_menu('admin/slider/manage'); ?>"><a href="<?php echo site_url('admin/slider/manage'); ?>"><?php echo lang_key('add_new'); ?></a></li>
                </ul>
            </li>
        <?php } ?>
        ...
        <?php endif; ?>
        <li class="<?php echo is_active_menu('admin/auction/'); ?>">

            <a href="#" class="dropdown-toggle">
                <i class="fa fa-bars"></i>
                <span><?php echo 'Auction'; ?></span>
                <b class="arrow fa fa-angle-right"></b>
            </a>

            <ul class="submenu">
                <?php if ($user_type == 1) : ?>
                    <li class=""><a href="<?php echo site_url('admin/auction/auction_add'); ?>">
                            <?php echo lang_key('New Auciton'); ?>
                        </a>
                    </li>
                <?php endif; ?>
                <?php if ($user_type != 3) : ?>
                    <li class=""><a href="<?php echo site_url('admin/auction/auction_approved'); ?>">
                            <?php echo lang_key('Approve'); ?>
                        </a>
                    </li>

                    <li class=""><a href="<?php echo site_url('admin/auction/auction_pending'); ?>">
                            <?php echo lang_key('Pending'); ?>
                        </a>
                    </li>
                    <li class=""><a href="<?php echo site_url('admin/auction/auction_close'); ?>">
                            <?php echo lang_key('Close'); ?>
                        </a>
                    </li>
                <?php endif; ?>

                <?php if ($user_type == 3) : ?>
                    <li class=""><a href="<?php echo site_url('admin/auction/bid_products'); ?>">
                            <?php echo lang_key('Bidded Products'); ?>
                        </a>
                    </li>
                    <li class=""><a href="<?php echo site_url('admin/auction/purchase_history'); ?>">
                            <?php echo lang_key('Purchase History'); ?>
                        </a>
                    </li>
                <?php endif; ?>
            </ul>
        ...
        <?php if (is_admin()) { ?>
            ...
            <li class="<?php echo is_active_menu('admin/blog/'); ?>">
                ...
                <ul class="submenu">
                    <li class="<?php echo is_active_menu('admin/blog/all'); ?>"><a href="<?php echo site_url('admin/blog/all'); ?>"><?php echo lang_key('all_posts'); ?></a></li>
                    <li class="<?php echo is_active_menu('admin/blog/manage'); ?>"><a href="<?php echo site_url('admin/blog/manage'); ?>"><?php echo lang_key('new_post'); ?></a></li>
                </ul>
            </li>
            <li class="<?php echo is_active_menu('admin/page/'); ?>">
                ...
                <ul class="submenu">
                    <!--<li class="active"> HIGHLIGHTS SUBMENU-->
                    <li class="<?php echo is_active_menu('admin/page/all'); ?>"><a href="<?php echo site_url('admin/page/all'); ?>"><?php echo lang_key('all_pages'); ?></a></li>
                    <li class="<?php echo is_active_menu('admin/page/index'); ?>"><a href="<?php echo site_url('admin/page/index'); ?>"><?php echo lang_key('new_page'); ?></a></li>
                    <li class="<?php echo is_active_menu('admin/page/menu'); ?>"><a href="<?php echo site_url('admin/page/menu'); ?>"><?php echo lang_key('menu'); ?></a></li>
                </ul>
            </li>
            <li class="<?php echo is_active_menu('admin/system'); ?>">
                ...
                <ul class="submenu">
                    <li class="<?php echo is_active_menu('admin/system/allbackups'); ?>"><a href="<?php echo site_url('admin/system/allbackups'); ?>"><?php echo lang_key('manage_backups'); ?></a></li>
                    <li class="<?php echo is_active_menu('admin/system/smtpemailsettings'); ?>"><a href="<?php echo site_url('admin/system/smtpemailsettings'); ?>"><?php echo lang_key('smtp_email_settings'); ?></a>
                    </li>
                    <li class="<?php echo is_active_menu('admin/system/emailtmpl'); ?>"><a href="<?php echo site_url('admin/system/emailtmpl'); ?>"><?php echo lang_key('edit_email_text'); ?></a></li>
                    <li class="<?php echo is_active_menu('admin/system/debugemail'); ?>"><a href="<?php echo site_url('admin/system/debugemail'); ?>"><?php echo lang_key('debug_email'); ?></a></li>
                    <li class="<?php echo is_active_menu('admin/system/sitesettings'); ?>"><a href="<?php echo site_url('admin/system/sitesettings'); ?>"><?php echo lang_key('default_site_settings'); ?></a></li>
                    <li class="<?php echo is_active_menu('admin/system/settings'); ?>"><a href="<?php echo site_url('admin/system/settings'); ?>"><?php echo lang_key('admin_settings'); ?></a></li>
                    <li class="<?php echo is_active_menu('admin/system/generatesitemap'); ?>"><a href="<?php echo site_url('admin/system/generatesitemap'); ?>"><?php echo lang_key('sitemap'); ?></a></li>
