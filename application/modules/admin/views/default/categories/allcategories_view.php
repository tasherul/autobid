  ...
  <div class="col-md-12">
    <div class="box">
      ...
      <div class="box-content">                    
        ...
        <?php }else{?>
        <form action="<?php echo site_url('admin/category/save_category_order');?>" method="post">
          ...
          <table id="all-posts" class="table table-hover">
             ...
             <tbody  id="sorttable"  class="droptrue">
          	<?php $i=1;foreach($posts->result() as $row):?>
                 <tr>
                    <td data-title="#" class="numeric dragable"><?php echo $i;?>
          ...
          <button type="submit" class="btn btn-success">Save Order</button> (You can Drag Drop table rows to sort category order)
        </form>
        <?php }?>
        </div>
    </div>
