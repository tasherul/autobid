            ...
            <div class="box-content">
                ...
                <form class="form-horizontal" action="<?php echo site_url('admin/updateprofile'); ?>" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-lg-6 col-sm-12">
                            <?php if (file_exists('uploads/images/' . $profile->nid_or_passport)) : ?>
                                <div class="form-group">
                                    <label>NID or Passport</label>
                                    <a href="<?php echo base_url('uploads/images/' . $profile->nid_or_passport) ?>" target="_blank" class="">
                                        <img class="thumbnail" id="user_photo" src="<?php echo base_url('uploads/images/' . $profile->nid_or_passport) ?>" style="width:100px;" />
                                    </a>
                                    <form id="upload_nid_form" method="POST" enctype="multipart/form-data">
                                        <div class="form-group mb-2">
                                            <!-- <input type="hidden" name="user_id" value="<?= $profile->id ?>">
                                        <input type="file" name="nid_or_passport" style="margin-bottom: 10px;" required>
                                        <button type="button" id="uploadNID" class="btn btn-info">Upload</button> -->
                                        </div>
                                        <script>
                                            $('#uploadNID').click(function(e) {
                                                e.preventDefault();
                                                $('#upload_nid_form').submit();
                                            });
                                            $('#upload_nid_form').submit(function(e) {
                                                e.preventDefault();
                                                $.ajax({
                                                    type: "post",
                                                    url: "<?= site_url('admin/upload_nid') ?>",
