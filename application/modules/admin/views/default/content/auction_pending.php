...
<div class="row">
    <div class="col-md-12">
        <div class="box">
            <div class="box-title">
                <h3><i class="fa fa-bars"></i> <?php echo lang_key('Pending Auctions'); ?></h3>
                <div class="box-tool">
            ...
            <div class="box-content">
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-4 col-xs-12 pull-right">
                        <form action="<?php echo site_url('admin/auction/auction_pending_ajax_view/0/0'); ?>" method="post" id="table-search-from" class="form-inline pull-right">
                            <div class="">
...
<script type="text/javascript">
    jQuery(document).ready(function() {
        ...
        $('.search-plain').click(function() {
            ...
            $('#table-search-from').attr('action', '<?php echo site_url(); ?>admin/auction/auction_pending_ajax_view/' + start + '/' + 0);
