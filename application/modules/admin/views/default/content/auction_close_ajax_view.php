...
<table id="all-posts" class="table table-hover table-advance">
    ...
    <thead>
        ...
        <tr>
            ...
            <th class="numeric email"><?php echo lang_key('Min Bid'); ?></th>
    ...
    <tbody>
        ...
        foreach ($auctions as $row) :  ?>
            ...
            <tr>
                ...
                <td data-title="<?php echo lang_key('Start Time'); ?>" class="numeric"><?php echo date('d/m/Y h:i:s', strtotime($row->start_time)) ?></td>
                <td data-title="<?php echo lang_key('End Time'); ?>" class="numeric"><?php echo date('d/m/Y h:i:s', strtotime($row->end_time)) ?></td>

                <td data-title="<?php echo lang_key('status'); ?>" class="numeric">
                    <select onchange="change_auction_status(<?= $row->auction_id ?>)" name="auction_status" id="auction_status" class="bg-light">
...
<script>
    function change_auction_status(auction_id) {
