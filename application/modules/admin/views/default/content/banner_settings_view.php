  ...
  <div class="col-md-12">
          ...
          <div class="form-group">
              ...
              <div class="col-sm-4 col-lg-5 controls">
                  ...
                  if(get_settings('banner_settings','disable_all_map','No')=='No')
                    $options = array("Parallax Slider","Google Map", "Layer Slider");
                  else
                    $options = array("Parallax Slider", "Layer Slider");
    ...
    <div class="box">
        ...
        <div class="box-content">
            ...
            <div class="form-group">
              <label class="col-sm-3 col-lg-2 control-label"><?php echo lang_key('disable_all_map');?>:</label>
              <div class="col-sm-4 col-lg-5 controls">
                  <?php $v = (set_value('disable_all_map')!='')?set_value('disable_all_map'):get_settings('banner_settings','disable_all_map', 8);?>
                  <select id="disable_all_map" name="disable_all_map" class="form-control input-sm">
                      <?php 
          ...
          <div class="form-group">
            <label class="col-sm-3 col-lg-2 control-label">&nbsp;</label>
              <div class="col-sm-9 col-lg-10 controls">
                  <?php $v = (set_value('show_bg_gradient')!='')?set_value('show_bg_gradient'):get_settings('banner_settings','show_bg_gradient', '0');?>
                  <div class="input-group show_bg_gradient" data-color="<?php echo $v;?>" data-color-format="rgba">
                  <label>
                    <?php $chk = ($v==1)?'checked="checked"':'';?>
                    <input style="width:40px;" type="checkbox" name="show_bg_gradient" id="show_bg_gradient" class="form-control" value="1" <?php echo $chk;?>>
                    <?php echo lang_key('show_bg_gradient');?>
                  </label>
                  </div>
              </div>
          </div>
...
jQuery(document).ready(function(){
    ...
    jQuery('#disable_all_map').change(function(){
      var val = jQuery(this).val();
      if(val=='Yes')
      {
        jQuery('#map_settings_holder').hide();
      }
      else
      {
        jQuery('#map_settings_holder').show();
      }
