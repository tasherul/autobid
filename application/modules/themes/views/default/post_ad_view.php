    ...
    <form action="<?php echo site_url('create-ad'); ?>" method="post" role="form" class="form-horizontal">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="alert alert-info" style="padding:10px;font-weight:bold">
                                <?php echo lang_key(isset($package->title) ? $package->title : ''); ?><br />
                                <?php echo lang_key('price'); ?> : <?php echo show_package_price(isset($package->price) ? $package->price : '0'); ?><br />
                                <?php echo lang_key('expiration_time'); ?> : <?= isset($package->expiration_time) ? $package->expiration_time : ''; ?> <?php echo lang_key('days'); ?>
                            </div>
                            <div class="clearfix" style="margin-top:5px;"></div>
                ...
                <h4 style="margin-top: 30px;"><?php echo lang_key('Auction Info'); ?></h4>
                <hr />
                <div style="padding: 10px 0px;">
                    <div class="form-group text-center">
                        <?php $v = (set_value('is_auction') != '') ? set_value('is_auction') : ''; ?>
                        <input type="checkbox" style="cursor: pointer;" name="is_auction" id="is_auction" <?= $v == 'on' ? 'checked' : '' ?>>
                        <label for="is_auction" style="cursor: pointer;">Is Auction </label>
                    </div>
                </div>
                <div class="row" id="auction_div" style="display: <?= $v == 'on' ? 'block' : 'none' ?>;">
                    <div class="col-md-12">
                        <div class="form-group">
                            <?php $v = (set_value('asking_bid') != '') ? set_value('asking_bid') : ''; ?>
                            <label for="">Min Bid</label>
                            <input type="number" class="form-control" min="1" name="asking_bid" id="asking_bid" value="<?= isset($auction) ? $auction->asking_bid : $v ?>">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="">Start Time</label>
                            <?php $v = (set_value('start_time') != '') ? set_value('start_time') : ''; ?>
                            <input type="datetime-local" class="form-control" name="start_time" id="start_time" value="<?= isset($auction) ? $auction->start_time : $v ?>" placeholder="Start date and time">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="">End Time</label>
                            <?php $v = (set_value('end_time') != '') ? set_value('end_time') : ''; ?>
                            <input type="datetime-local" class="form-control" name="end_time" id="end_time" placeholder="End date and time" value="<?= isset($auction) ? $auction->end_time : $v ?>">
                        </div>
                    </div>
