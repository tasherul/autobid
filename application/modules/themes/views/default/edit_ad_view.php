    ...
    <form action="<?php echo site_url('update-ad'); ?>" method="post" role="form" class="form-horizontal">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6">
                ...
                if ($auction->auction_status == 0 || $user_type == 1) : ?>
                    <h4 style="margin-top: 30px;"><?php echo lang_key('Auction Info'); ?></h4>
                    <hr />
                    <div style="padding: 10px 0px;">
                        <div class="form-group text-center">
                            <?php $v = (set_value('is_auction') != '') ? set_value('is_auction') : ''; ?>
                            <input type="checkbox" style="cursor: pointer;" <?= $post->is_auction == 1 ? 'checked' : ($v == 'on' ? 'checked' : '') ?> name="is_auction" id="is_auction">
                            <label for="is_auction" style="cursor: pointer;">Is Auction</label>
                        </div>
                    </div>

                    <div class="row" id="auction_div" style="display: <?= $post->is_auction == 1 ? 'block' : ($v == 'on' ? 'block' : 'none') ?>;">
                        <div class="col-md-12">
                            <div class="form-group">
                                <?php $v = (set_value('asking_bid') != '') ? set_value('asking_bid') : ''; ?>
                                <label for="">Min Bid</label>
                                <input type="number" class="form-control" min="1" name="asking_bid" id="asking_bid" value="<?= isset($auction) ? $auction->min_bid : $v ?>">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="datetime-local" class="form-control" name="end_time" id="end_time" placeholder="End date and time" value="<?= isset($auction) ? $auction->end_time : 0 ?>">
                            </div>
                        </div>
