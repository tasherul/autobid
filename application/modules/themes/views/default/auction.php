            ...
            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                <div class="item grid-box-item">
                    ...
                    <div class="grid-box-content" style="padding:12px; padding-top:0;">
                            ...
                            <?php if (get_settings('content_settings', 'enable_review', 'Yes') == 'Yes') { ?>
                                <div class="row grid-rating-holder">
                                    <div class="col-xs-12 col-sm-12 col-md-12 info-dta info-price">
                                        ...
                                        <a href="<?php echo $detail_link; ?>#review" style="margin-right:2px;">
                        ...
                        <h4 class="item-title"><a href="<?php echo $detail_link; ?>" style="color:#000000f0"><?php echo format_long_text(get_post_data_by_lang($post, 'title')); ?></a></h4>
                        ...
                        <div class="details-cars">
                            ...
                            <div class="info-dta"><i class="fa fa-tachometer"></i> : <?php echo $post->mileage . ' ' . $this->session->userdata('mileage_unit'); ?></div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                </div>
