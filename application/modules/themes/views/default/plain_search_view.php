                ...
                <div class="s-widget">
                    ...
                    <div class="widget-content search">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="mileage_slider" name="mileage_slider" value="" <?php echo $mileage_from;
                                                                                                    echo $mileage_to; ?> />
                        </div>

                        <div class="form-group">
                            <label><?php echo lang_key('price_range'); ?></label>
                            <input type="text" id="price_slider" name="price_slider" value="" <?php echo $data_from;
                                                                                                echo $data_to; ?> />
                        </div>
                        ...
                        <?php if (get_settings('content_settings', 'disable_location', 'no') == 'no') { ?>
                            ...
                            ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="javascript:void(0);" onclick="findLocation()" class="btn btn-primary btn-xs adv-find-my-location"><i class="fa fa-location-arrow"></i></a>
                        ...
                        <!-- Button -->
                        <button class="btn btn-primary submit-search-button" type="submit"><?php echo lang_key('search'); ?></button>&nbsp;
