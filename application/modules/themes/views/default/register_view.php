    ...
    <div class="row">
        ...
        <div class="col-md-7">
            ...
            <div class="well login-reg-form">
                <!-- Heading -->
                <h4 style="color:#461d51"><?php echo lang_key('register_your_account'); ?></h4>
                ...
                <form style="max-width: 615px" class="form-horizontal" role="form" action="<?php echo site_url('account/register/'); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="nid_or_passport" class="col-sm-3 control-label"><?php echo lang_key('NID or Passport'); ?></label>
                        <div class="col-sm-9">
                            <input type="file" name="nid_or_passport" value="<?php echo set_value('nid_or_passport'); ?>" placeholder="<?php echo lang_key('NID or Passport'); ?>" class="form-control" required>
                            <?= !empty($file) ? $file : '' ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="user_type" class="col-sm-3 control-label"><?php echo lang_key('Account Type'); ?></label>
                        <div class="col-sm-9">
                            <?php $curr_value = (set_value('user_type') != '') ? set_value('user_type') : $this->session->userdata('user_type'); ?>
                            <select class="form-control" name="user_type" required>
                                <option value="">Select Account Type</option>
                                <?php $sel = ($curr_value == '2') ? 'selected="selected"' : ''; ?>
                                <option value="2" <?php echo $sel; ?>><?php echo lang_key('Seller'); ?></option>
                                <?php $sel = ($curr_value == '3') ? 'selected="selected"' : ''; ?>
                                <option value="3" <?php echo $sel; ?>><?php echo lang_key('Buyer'); ?></option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-9">
                            <!-- Buton -->
                            <button type="submit" class="btn btn-primary"><?php echo lang_key('register'); ?></button>&nbsp;
                ...
                ?>
                    <!-- Social Media Login -->
                    <div class="s-media text-center" style="display: none;">
                        <!-- Button -->
