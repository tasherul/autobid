    ...
    <div class="row">
        ...
        <div class="col-md-5">
            ...
            <div class="well login-reg-form login-reg-form-page">
                <!-- Heading -->
                <h4 style="color:#461d51"><i class="fa fa-sign-in"></i> <?php echo lang_key('login_to_your_account'); ?></h4>
                <hr />
                <!-- Form -->
                <form action="<?php echo site_url('account/login'); ?>" class="form-horizontal" role="form" method="post">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-9">
                            <!-- Button -->
                            <button type="submit" class="btn btn-primary ripple"><?php echo lang_key('login'); ?></button>&nbsp;
